...
int main()
{
    ...
    for (int i=0; i<3; i++) {
        err = net_buffer_push(
            &net_tx_buffer,
            (bytestring_t){
                {*inc_data}, // TODO this is wrong, this is pointing to the first item in the array
                sizeof(inc_data),
                inc_data[3]
            }
        );
    ...
    // test net_buffer_pop FAIL? Might be working but errors at push
